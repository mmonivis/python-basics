...
# --------------- EXERCISE 6 / SUPER BONUS ---------------- #

# Given a list (example below), create a function that takes the list and returns a
# dictionary that has a key "one," "two," "three," and so on. Assign the value for each key to
# be a list of however many times a value shows up in the list.
